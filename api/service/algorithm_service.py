...
def _calculate_hours(subject: Subject) -> None:
    ...
    _calculate_all_hours(remain_hours, subject, prac_teacher_groups, hours)
    print('@@@@@@@@', remain_hours)
...
def _calculate_all_hours(remain_hours: list, subject: Subject, prac_teacher_groups: list, hours: list) -> None:
    ...
    for i in range(len(remain_hours)):
        ...
        remain_hours[i] -= subject.practice_hour * prac_teacher_groups[i]
        hours[i] += abs(remain_hours[i])
